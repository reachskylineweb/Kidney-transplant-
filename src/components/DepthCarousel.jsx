          ...
          >
            {item.image ? (
              ...
              <div className="depth-carousel__placeholder">
                ...
                <div className="placeholder-badge">EXPERT CLINICIAN</div>
                <div className="placeholder-name">{item.name || 'GEM Specialist'}</div>
                <div className="placeholder-title">{item.qual || 'Transplant Faculty'}</div>
              </div>
            )}
            <span
